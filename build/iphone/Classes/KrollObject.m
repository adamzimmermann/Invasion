...
//@interface InvasionObject : NSObject
//@end

@interface InvasionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InvasionObject class]])
		{
			for (NSString *key in [[(InvasionObject*)o modules] allKeys])
			{
