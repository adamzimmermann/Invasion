...
// in simulator we redefine to format for Invasion Developer console
...
{\
	NSString * exceptionName = [@"org.invasion." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.invasion";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIInvasionNativeItemNone = -1, 
	UIInvasionNativeItemSpinner = -2,
	UIInvasionNativeItemProgressBar = -3,
	
	UIInvasionNativeItemSlider = -4,
	UIInvasionNativeItemSwitch = -5,
	UIInvasionNativeItemMultiButton = -6,
	UIInvasionNativeItemSegmented = -7,
	
	UIInvasionNativeItemTextView = -8,
	UIInvasionNativeItemTextField = -9,
	UIInvasionNativeItemSearchBar = -10,
	
	UIInvasionNativeItemPicker = -11,
	UIInvasionNativeItemDatePicker = -12,
	
	UIInvasionNativeItemInfoLight = -13,
	UIInvasionNativeItemInfoDark = -14,
	
	UIInvasionNativeItemDisclosure = -15,
	
	UIInvasionNativeItemContactAdd = -16
};
